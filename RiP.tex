...
\subsection{Explicit inversion of $\delta$: motivation}
...
\[
	\xymatrix@C=10mm{
		& & & \h^0(\Gamma,\Hom(\Delta_0,M))\ar[d] &\\
			 & \frac{C^0}{B^0}\bigg(\Gamma,M\bigg)\ar[r]\ar[d]   & \frac{C^0}{B^0}\bigg(\Gamma,\Hom(\Delta,M)\bigg)\ar[r]\ar[d] &  \frac{C^0}{B^0}\bigg(\Gamma,\Hom(\Delta_0,M)\bigg)\ar[r]\ar[d] &0\\
