...
The natural restriction maps $\widetilde{G}_\infty \twoheadrightarrow G_\pri$ and $\widetilde{G}_\infty \twoheadrightarrow G_{\overline{\pri}}$ allow us to identify $\widetilde{G}_\infty$ with  $G_\pri \times G_{\overline{\pri}}$. This further allows to consider the following isomorphism of topological $\Z_p$-algebras:
...
The purpose of our paper is to present an algorithm that computes as an element of $\Lambda$ the Mahler transform (denoted $L_{p,f,\psi}(x,y)$ here) of $\mu_{f,\psi}$ evaluated at the path $\left\{0 \rightarrow \infty \right\}$. To wit, we have
\begin{align*}
\D_2 &\cong \Lambda, \\
