...
{\bfseries\itshape}% formatting commands to apply to the whole heading
...
Let $\n$ be an ideal in $O_K$ satisfying the following condition:
...
\underline{\emph{When an elliptic curve $E/\Q$ has CM and has good ordinary reduction at $p$}}
...
Our methodology in this case will be to show that there exists no irreducible element in $\Lambda$ that divides both
\begin{align*}
L_{p,f,\chi,\psi}(x,y) \text{ and } L_{p,f,\chi,\psi}(y,x).
\end{align*}

\underline{\emph{When an elliptic curve $E/\Q$ has good supersingular reduction at $p$}}
